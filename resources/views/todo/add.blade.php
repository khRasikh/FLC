            ...
            <div class="page-content">
                ...
                <div class="row">
                    ...
                    <!-- PAGE CONTENT BEGINS -->
                        ...
                        <form method="post" action="{{route('todo_store')}}" class="form-horizontal" id="validation-form">
                            {{csrf_field()}}
                        <h4 class="header large lighter blue"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Create TO DO</h4>
                        
                        <div class="form-group">
                            <label class="control-label col-sm-2" for="text">Description</label>
                            <div class="col-sm-4">
                                <input type="text" name="text" id="text" class="form-control border-form" required="required">
                                @include('includes.form_fields_validation_message', ['name' => 'text'])
                            </div>
                            
                            <label class="control-label col-sm-2" for="date">Date</label>
                            <div class="col-sm-4">
                            {!! Form::text('date', date('Y-m-d'), [/*"data-date-format" => "yyyy-mm-dd",*/ "class" => "form-control date-picker border-form","required"]) !!}
