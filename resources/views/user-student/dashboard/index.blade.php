                        ...
                        <div class="row">
                           {{-- <div class="col-sm-12 align-right hidden-print">
                            ...
                            <div class="col-xs-12 col-sm-3 center">
                             ...
                             <div>
                                    <div class="space-6"></div>
                                     <div class="width-70 label label-warning label-xlg arrowed-right overflow-hidden">
                                        <div class="inline position-relative ">
                                            <a href="#" class="user-title-label dropdown-toggle" data-toggle="dropdown">
                                                <span class="white" >My Classes</span>
                                            </a>
                                        </div> 
                            ...
                            <div class="col-xs-12 col-sm-9">
                                ...
                                <div class="space-6"></div>
                                <div class="label label-info label-xlg arrowed-in arrowed-right arrowed">About My, <a href="#" style="color: white; ">Performances</a></div>
                                <div class="space-6"></div>
                                <div class="profile-user-info profile-user-info-striped">
                                   
                                    <div class="profile-info-row">
                                        <div class="profile-info-name"> Course ID: </div>
                                        <div class="profile-info-value">
                                            <span class="editable" id="reg_no">{{ $data['student']->reg_no }}</span>
                                        </div>
                                        <div class="profile-info-name"> Started Date :</div>
                                        <div class="profile-info-value">
                                            <span class="editable" id="semester">{{ $data['student']->reg_date }}</span>
                                        </div>
                                    </div>
                                    <div class="profile-info-row">
                                    ...
                                    <div class="profile-info-row">
                                        <div class="profile-info-name"> Pretest Score: </div>
                                        <div class="profile-info-value">
                                            <span class="editable" >55</span>
                                        </div>
                                        <div class="profile-info-name"> Participation :</div>
                                        <div class="profile-info-value">
                                            <span class="editable" id="participation">Good</span>
                                        </div>
                                    </div>

                                    <div class="profile-info-row">
                                        <div class="profile-info-name"> Assignment: </div>
                                        <div class="profile-info-value">
                                            <span class="editable" id="reg_no">
                                                <a href="user-student/assignment"> First Assignment</span></a>
                                        </div>
                                        <div class="profile-info-name"> Quizzez :</div>
                                        <div class="profile-info-value">
                                            <span class="editable" id="reg_date">NO</span>
                                        </div>
                                    </div>

                                    <div class="profile-info-row">
                                        <div class="profile-info-name"> Progress Exam: </div>
                                        <div class="profile-info-value">
                                            <span class="editable" id="university_reg"><a href="user-student/exams">Unknown</a></span>
                                        </div>
                                        <div class="profile-info-name"> Final Test : </div>
                                        <div class="profile-info-value">
                                    ...
                                    <div class="profile-info-row">
                                        <div class="profile-info-name"> Final Test Date : </div>
                                        <div class="profile-info-value">
                                            <span class="editable" id="student_name">{{ $data['student']->gender }}</span>
                                        </div>
                                        <div class="profile-info-name"> Final Result : </div>
                                        <div class="profile-info-value">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-9">
                                ...
                                <div class="profile-user-info profile-user-info-striped">
                                    ...
                                    <div class="profile-info-row">
                                        <div class="profile-info-name"> FLC.Reg.: </div>
                                        <div class="profile-info-value">
