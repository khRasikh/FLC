...
transition-duration: 0.15s;">
        ...
        <li class="{!! request()->is('list_*')||request()->is('add_.*')?'active open':'' !!}  hover">
            <a href="#" class="dropdown-toggle">
                <i class="menu-icon fa fa-users" aria-hidden="true"></i>
                <span class="menu-text"> Test Taker</span>
            </a>

            <b class="arrow"></b>

            <ul class="submenu">
                <li class="{!! request()->is('list_test*')?'active open':'' !!} hover">
                    <a href="{{route('list_test_taker')}}">
                ...
                <li class="{!! request()->is('add_*')?'active open':'' !!} hover">
                    <a href="{{route('add_test_taker')}}">
                        <i class="menu-icon fa fa-caret-right"></i>
                        add Test Taker
                        <b class="arrow fa fa-angle-r"></b>
                    </a>
        ...
        {{-- placement test --}}
        @ability('super-admin','student-staff')
        <li class="{!! request()->is('placement_test*')?'active open':'' !!}  hover">
            <a href="#" class="dropdown-toggle">
                <i class="menu-icon fa fa-users" aria-hidden="true"></i>
                <span class="menu-text"> Placement Test</span>
            </a>

            <b class="arrow"></b>

            <ul class="submenu">
                <li class="{!! request()->is('placement_test_list*')?'active open':'' !!} hover">
                    <a href="{{route('placement_test_list')}}">
                        <i class="menu-icon fa fa-caret-right"></i>
                        List Placement test
                        <b class="arrow fa fa-angle-r"></b>
                    </a>
        ...
        {{-- Todo list --}}
        @ability('super-admin','student-staff')
        <li class="{!! request()->is('todo_*')?'active open':'' !!}  hover">
            <a href="#" class="dropdown-toggle">
                <i class="menu-icon fa fa-users" aria-hidden="true"></i>
