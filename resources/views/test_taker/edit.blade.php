            ...
            <div class="page-content">
                ...
                <div class="row">
                    ...
                    <!-- PAGE CONTENT BEGINS -->
                        ...
                        {!! Form::open(['route' => 'store_test_taker', 'method' => 'POST', 'class' => 'form-horizontal',
                        'id' => 'validation-form', "enctype" => "multipart/form-data"]) !!}
                        <form action="{{route('store_test_taker',$test->id)}}" method="post" id="validation-form" class="form-horizontal">
                            {{csrf_field()}}
                        @include('test_taker.includes.form')
