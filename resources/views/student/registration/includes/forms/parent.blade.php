...
<div class="label label-warning arrowed-in arrowed-right arrowed">Brother's Detail</div>
<hr class="hr-8">

<div class="form-group">
    {!! Form::label('mother_name', 'NAME OF Brother', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-3">
...
<div id="guardian-detail">
    <hr class="hr-8">
    <div class="form-group">
        {!! Form::label('guardian_name', 'NAME OF GUARDIAN', ['class' => 'col-sm-2 control-label']) !!}
        <div class="col-sm-3">
