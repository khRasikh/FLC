...
<div class="form-group">
    ...
    {!! Form::label('university_reg', 'FLC REG. NO.', ['class' => 'col-sm-2 control-label']) !!}
    <div class="col-sm-2">
...
<div class="form-group">
    {!! Form::label('first_name', 'Student Fullname', ['class' => 'col-sm-2 control-label',]) !!}
    <div class="col-sm-3">
...
<div class="form-group">
    ...
    {!! Form::label('mobile_1', 'Phone 1', ['class' => 'col-sm-1 control-label']) !!}
    <div class="col-sm-3">
    ...
    {!! Form::label('mobile_2', 'Phone 2', ['class' => 'col-sm-1 control-label']) !!}
    <div class="col-sm-3">
